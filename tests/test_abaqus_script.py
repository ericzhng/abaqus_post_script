...
# Add the src directory to the Python path to allow importing abaqus_script
sys.path.insert(
...
from abaqus_script import (
    _get_file_path,
    _upgrade_odb_if_necessary,
    extract_odb_data,
)
...
class TestAbaqusScript(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_dir = r"C:\Temp\12032\step-01-Solver_Braking_1.24"
    ...
    def test_upgrade_odb_if_necessary(self):
        """Integration test for _upgrade_odb_if_necessary."""

        test_odb_path = os.path.join(self.test_dir, 'main.odb')
        new_odb_path = _upgrade_odb_if_necessary(test_odb_path)
